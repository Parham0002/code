...
glasses_of_water = 3
glasses_of_waters = glasses_of_water + 2
print(glasses_of_waters)
...
global_mean_sea_level_2018 = 21 + 0.6
...
gift_list = ["car", "flower", "watch", "perfume"]
print(gift_list)
...
grocery_items = {"milk", "butter", "bread"}
print(grocery_items)
